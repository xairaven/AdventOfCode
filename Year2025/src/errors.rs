...
pub enum Error {
    ...
    #[error("Day 09. {0}")]
    Day09(#[from] days::day09::errors::Day09Error),

    #[error("Day 10. {0}")]
    Day10(#[from] days::day10::errors::Day10Error),

    #[error("Day 11. {0}")]
    Day11(#[from] days::day11::errors::Day11Error),

    #[error("Day 12. {0}")]
    Day12(#[from] days::day12::errors::Day12Error),
}
